...
public class Cliente extends Thread{ // Classe Cliente eh uma thread
    ...
    public Cliente(Conta santander, Loja[] lojas){
        //this.funcionarios1 = funcionarios1 = new Funcionario[]{new Funcionario(new Conta(0), new Conta(0), 0), new Funcionario(new Conta(0), new Conta(0), 0)};
        //this.funcionarios2 = funcionarios2 = new Funcionario[]{new Funcionario(new Conta(0), new Conta(0), 0), new Funcionario(new Conta(0), new Conta(0), 0)};
